...
PRETAINED_WEIGHT_PATH = 'network/xception-b5690688.pth'
...
class Xception(nn.Module):
    ...
    def features(self, input):
        ...
        x0 = self.fea_part1_0(input)

        x1 = self.fea_part1_1(x0)
        x2 = self.fea_part1_2(x1)
        x3 = self.fea_part1_3(x2)
        x4 = self.fea_part2_0(x3)
        x5 = self.fea_part2_1(x4)
        x6 = self.fea_part3(x5)
    ...
    def __init__(self, modelchoice, num_out_classes=2, dropout=0.5,
        ...
        if modelchoice == 'xception':
            ...
            def return_pytorch04_xception(pretrained=True):
                ...
                if pretrained:
                    print("using pretrained xception model")
